---
title: "Job Flow — Session Start Index"
status: project-owned
generated: 2026-05-21
companion_docs: ["JOB_FLOW_WHAT_IT_IS.md", "JOB_FLOW_INVENTORY.md", "00-START-NEXT-SESSION.md"]
---

# Job Flow — Session Start
...
2. `docs/JOB_FLOW_WHAT_IT_IS.md` — narrative anchor
3. `docs/JOB_FLOW_INVENTORY.md` — runtime anchor (regenerable)
...
- _example: `docs/architecture/2024_PROPOSAL.md` — superseded by
  `docs/JOB_FLOW_PIPELINE.md`; kept for archeology only._
...
- _Adding a new endpoint:_ `docs/JOB_FLOW_PIPELINE.md` §"Entry points"
