---
title: "Job Flow — Translation Layer"
status: project-owned
generated: 2026-05-21
companion_docs: ["JOB_FLOW_WHAT_IT_IS.md", "JOB_FLOW_INVENTORY.md", "JOB_FLOW_PIPELINE.md", "JOB_FLOW_BEHAVIOR_LAYER.md"]
---

# Job Flow — Translation Layer
...
If a fact isn't in `JOB_FLOW_WHAT_IT_IS.md`,
`JOB_FLOW_INVENTORY.md`, `JOB_FLOW_PIPELINE.md`,
`JOB_FLOW_BEHAVIOR_LAYER.md`, the latest handoff, or this file —
...
1. `docs/JOB_FLOW_WHAT_IT_IS.md` — narrative anchor (what the
   system *is*)
2. `docs/JOB_FLOW_INVENTORY.md` — runtime anchor (what currently
   *exists*)
3. `docs/JOB_FLOW_PIPELINE.md` — runtime flow map (how requests
   *move*)
4. `docs/JOB_FLOW_BEHAVIOR_LAYER.md` — voice / display contract
