---
title: "Job Flow — Behavior Layer"
status: stub
generated: 2026-05-21
companion_docs: ["JOB_FLOW_WHAT_IT_IS.md", "JOB_FLOW_INVENTORY.md", "JOB_FLOW_PIPELINE.md"]
---

# Job Flow — Behavior Layer (BEHAVIOR_LAYER.md)

> **Read-order note:** this doc is the **behavior** companion to the
> two-doc anchor pair and `JOB_FLOW_PIPELINE.md`. Where the
...
This is the same line drawn in `JOB_FLOW_PIPELINE.md`, restated
...
> Replace it before shipping with patterns from Job Flow.
