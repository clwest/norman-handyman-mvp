---
title: "Job Flow — Runtime Flow Map"
status: stub
generated: 2026-05-21
companion_docs: ["JOB_FLOW_WHAT_IT_IS.md", "JOB_FLOW_INVENTORY.md"]
---

# Job Flow — Runtime Flow Map (PIPELINE.md)

> **Read-order note:** this doc is the runtime flow companion to the
> two-doc anchor pair (`JOB_FLOW_WHAT_IT_IS.md` + `JOB_FLOW_INVENTORY.md`).
...
> **Replace the examples** with the real entry points for Job Flow.
...
> `JOB_FLOW_INVENTORY.md` that invokes an **LLM**, an **agent
