...
> **Source of truth for numbers:** `docs/JOB_FLOW_WHAT_IT_IS.md` (narrative)
> + `docs/JOB_FLOW_INVENTORY.md` (runtime-derived, regenerable).
...
3. Read `docs/JOB_FLOW_WHAT_IT_IS.md`.
4. Read `docs/JOB_FLOW_INVENTORY.md`.
